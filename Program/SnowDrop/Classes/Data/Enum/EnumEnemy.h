...
//
//---------------------------------------------------------
enum class ENEMY_MOUSE_STATE :int
{
	IDLE = 0,			//待機状態
	WANDERING = 1,		//徘徊状態
	ATTACK = 2,			//攻撃状態
...
//
//---------------------------------------------------------
enum class ENEMY_MOUSE_MOVE_STATE : int
{
	WANDERING = 0,	//徘徊状態
};

enum class ENEMY_MOUSE_ANIMATION_STATE :int
{
	IDLE = 0,//待機状態
	WANDERING = 1,		//徘徊状態
	ATTACK = 2,
...
enum class ENEMY_MOUSE_ACTION_STATE :int
{
	IDLE = 0,//待機状態
	WANDERING	= 1,
	ATTACK		= 2,
...
//---------------------------------------------------------
// Enum Class: MARIONETTE_STATE { int }
//
// 敵　MouseKing　の状態を列挙
//
//
//---------------------------------------------------------
enum class ENEMY_MARIONETTE_STATE :int
{
	IDLE = 0,			//待機状態
	WANDERING = 1,		//徘徊状態
	ATTACK = 2,			//攻撃状態
...
//
//---------------------------------------------------------
enum class ENEMY_MARIONETTE_MOVE_STATE : int
{
	WANDERING = 0,	//徘徊状態
};

enum class ENEMY_MARIONETTE_ANIMATION_STATE :int
{
	IDLE = 0,			//待機状態
	WANDERING = 1,		//徘徊状態
	ATTACK = 2,
...
enum class ENEMY_MARIONETTE_ACTION_STATE :int
{
	IDLE = 0,//待機状態
	WANDERING = 1,
	UNDER_ATTACK = 2,//攻撃受けた
